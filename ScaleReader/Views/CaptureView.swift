    ...
    private var tipCard: some View {
        VStack(alignment: .leading, spacing: 8) {
            Label("怎么用", systemImage: "lightbulb.fill")
                .font(.headline)
            Text("站上体脂秤完成测量，一屏拍一张（共约 10 屏）。先按【身体成分】键依次翻：\n体重 → 身体年龄 → BMI → 基础代谢 → 身体脂肪率 → 内脏脂肪指数；\n再按【部位】键切换 全身 / 上肢 / 躯干 / 下肢，每切换一次拍一张。\n拍照时让屏幕占满画面、避免反光（小数点才看得清）；屏幕会自动熄灭，请连着拍。拍完点“开始 AI 识别”——部位靠屏幕上被框选的那个词判断，不要求按顺序拍。")
                .font(.footnote)
